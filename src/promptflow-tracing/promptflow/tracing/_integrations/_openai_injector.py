...
def _openai_apis():
    sync_apis = (
        ...
        ("openai.resources.beta.threads.messages", "Messages", "delete", TraceType.MESSAGE, "openai_message_delete"),
        ...
        ("openai.resources.beta.threads.runs", "Steps", "list", TraceType.STEP, "openai_step_list"),
    )
    async_apis = (
        ...
        ("openai.resources.beta.threads.runs", "AsyncSteps", "list", TraceType.STEP, "openai_step_list_async"),
    )
    return sync_apis, async_apis
