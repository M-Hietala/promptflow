...
def _openai_apis():
    sync_apis = (
        ...
        ("openai.resources", "Files", "create", TraceType.FUNCTION, "openai_file_create"),
        ("openai.resources", "Files", "retrieve", TraceType.FUNCTION, "openai_file_retrieve"),
        ("openai.resources", "Files", "list", TraceType.FUNCTION, "openai_file_list"),
        ("openai.resources", "Files", "delete", TraceType.FUNCTION, "openai_file_delete"),
        ("openai.resources", "Files", "content", TraceType.FUNCTION, "openai_file_content"),
        ("openai.resources", "Files", "retrieve_content", TraceType.FUNCTION, "openai_file_retrieve_content"),
        ("openai.resources", "Files", "wait_for_processing", TraceType.FUNCTION, "openai_file_wait_for_processing"),
        ("openai.resources", "AsyncFiles", "list", TraceType.FUNCTION, "openai_file_list"),
        ("openai.resources.beta.assistants", "Assistants", "create", TraceType.FUNCTION, "openai_assistant_create"),
        ("openai.resources.beta.assistants", "Assistants", "retrieve", TraceType.FUNCTION, "openai_assistant_retrieve"),
        ("openai.resources.beta.assistants", "Assistants", "update", TraceType.FUNCTION, "openai_assistant_update"),
        ("openai.resources.beta.assistants", "Assistants", "list", TraceType.FUNCTION, "openai_assistant_list"),
        ("openai.resources.beta.assistants", "Assistants", "delete", TraceType.FUNCTION, "openai_assistant_delete"),
        ("openai.resources.beta.assistants", "AsyncAssistants", "list", TraceType.FUNCTION, "openai_assistant_list"),
        ("openai.resources.beta.threads", "Threads", "create", TraceType.FUNCTION, "openai_thread_create"),
        ("openai.resources.beta.threads", "Threads", "retrieve", TraceType.FUNCTION, "openai_thread_retrieve"),
        ("openai.resources.beta.threads", "Threads", "update", TraceType.FUNCTION, "openai_thread_update"),
        ("openai.resources.beta.threads", "Threads", "delete", TraceType.FUNCTION, "openai_thread_delete"),
        (
        ...
        ("openai.resources.beta.threads.messages", "Messages", "create", TraceType.FUNCTION, "openai_message_create"),
        (
        ...
        ("openai.resources.beta.threads.messages", "Messages", "update", TraceType.FUNCTION, "openai_message_update"),
        ("openai.resources.beta.threads.messages", "Messages", "list", TraceType.FUNCTION, "openai_message_list"),
        ("openai.resources.beta.threads.messages", "AsyncMessages", "list", TraceType.FUNCTION, "openai_message_list"),
        ("openai.resources.beta.threads.runs", "Runs", "create", TraceType.FUNCTION, "openai_run_create"),
        ("openai.resources.beta.threads.runs", "Runs", "retrieve", TraceType.FUNCTION, "openai_run_retrieve"),
        ("openai.resources.beta.threads.runs", "Runs", "update", TraceType.FUNCTION, "openai_run_update"),
        ("openai.resources.beta.threads.runs", "Runs", "list", TraceType.FUNCTION, "openai_run_list"),
        ("openai.resources.beta.threads.runs", "Runs", "cancel", TraceType.FUNCTION, "openai_run_cancel"),
        (
            "openai.resources.beta.threads.runs",
            "Runs",
            "create_and_poll",
            TraceType.FUNCTION,
            "openai_run_create_and_poll",
        ),
        (
            "openai.resources.beta.threads.runs",
            "Runs",
        ...
        ("openai.resources.beta.threads.runs", "Runs", "poll", TraceType.FUNCTION, "openai_run_poll"),
        ("openai.resources.beta.threads.runs", "Runs", "stream", TraceType.FUNCTION, "openai_run_stream"),
        (
            "openai.resources.beta.threads.runs",
            "Runs",
            "submit_tool_outputs",
        ...
        ("openai.resources.beta.threads.runs", "AsyncRuns", "list", TraceType.FUNCTION, "openai_run_list"),
        ("openai.resources.beta.threads.runs", "AsyncRuns", "stream", TraceType.FUNCTION, "openai_run_stream"),
        (
            "openai.resources.beta.threads.runs",
            "AsyncRuns",
            "create_and_stream",
        ...
        ("openai.resources.beta.threads.runs", "Steps", "retrieve", TraceType.FUNCTION, "openai_run_step_retrieve"),
        ("openai.resources.beta.threads.runs", "Steps", "list", TraceType.FUNCTION, "openai_run_steps_list"),
        ("openai.resources.beta.threads.runs", "AsyncSteps", "list", TraceType.FUNCTION, "openai_run_steps_list"),
        (
        ...
        ("openai.resources.beta.vector_stores", "FileBatches", "poll", TraceType.FUNCTION, "openai_file_batch_poll"),
        (
            "openai.resources.beta.vector_stores",
            "FileBatches",
            "upload_and_poll",
        ...
        ("openai.resources.beta.vector_stores", "Files", "create", TraceType.FUNCTION, "openai_file_create"),
        ("openai.resources.beta.vector_stores", "Files", "retrieve", TraceType.FUNCTION, "openai_file_retrieve"),
        ("openai.resources.beta.vector_stores", "Files", "list", TraceType.FUNCTION, "openai_file_list"),
        ("openai.resources.beta.vector_stores", "Files", "delete", TraceType.FUNCTION, "openai_file_delete"),
        (
            "openai.resources.beta.vector_stores",
            "Files",
            "create_and_poll",
        ...
        ("openai.resources.beta.vector_stores", "Files", "poll", TraceType.FUNCTION, "openai_file_poll"),
        ("openai.resources.beta.vector_stores", "Files", "upload", TraceType.FUNCTION, "openai_file_upload"),
        (
            "openai.resources.beta.vector_stores",
            "Files",
            "upload_and_poll",
        ...
        ("openai.resources.beta.vector_stores", "AsyncFiles", "list", TraceType.FUNCTION, "openai_file_list"),
        (
            "openai.resources.beta.vector_stores",
            "VectorStores",
            "create",
        ...
        ("openai.resources.beta.vector_stores", "VectorStores", "list", TraceType.FUNCTION, "openai_vector_store_list"),
        (
            "openai.resources.beta.vector_stores",
            "VectorStores",
            "delete",
    ...
    async_apis = (
        ...
        ("openai.resources", "AsyncFiles", "create", TraceType.FUNCTION, "openai_file_create_async"),
        ("openai.resources", "AsyncFiles", "retrieve", TraceType.FUNCTION, "openai_file_retrieve_async"),
        ("openai.resources", "AsyncFiles", "delete", TraceType.FUNCTION, "openai_file_delete_async"),
        ("openai.resources", "AsyncFiles", "content", TraceType.FUNCTION, "openai_file_content_async"),
        (
            "openai.resources",
            "AsyncFiles",
            "retrieve_content",
            TraceType.FUNCTION,
            "openai_file_retrieve_content_async",
        ),
        (
            "openai.resources",
            "AsyncFiles",
        ...
        ("openai.resources.beta.threads", "AsyncThreads", "create", TraceType.FUNCTION, "openai_thread_create_async"),
        (
            "openai.resources.beta.threads",
            "AsyncThreads",
            "retrieve",
            TraceType.FUNCTION,
            "openai_thread_retrieve_async",
        ),
        ("openai.resources.beta.threads", "AsyncThreads", "update", TraceType.FUNCTION, "openai_thread_update_async"),
        ("openai.resources.beta.threads", "AsyncThreads", "delete", TraceType.FUNCTION, "openai_thread_delete_async"),
        (
            "openai.resources.beta.threads",
            "AsyncThreads",
            "create_and_run",
        ...
        ("openai.resources.beta.threads.runs", "AsyncRuns", "create", TraceType.FUNCTION, "openai_run_create_async"),
        (
            "openai.resources.beta.threads.runs",
            "AsyncRuns",
            "retrieve",
            TraceType.FUNCTION,
            "openai_run_retrieve_async",
        ),
        ("openai.resources.beta.threads.runs", "AsyncRuns", "update", TraceType.FUNCTION, "openai_run_update_async"),
        ("openai.resources.beta.threads.runs", "AsyncRuns", "cancel", TraceType.FUNCTION, "openai_run_cancel_async"),
        (
            "openai.resources.beta.threads.runs",
            "AsyncRuns",
            "create_and_poll",
        ...
        ("openai.resources.beta.threads.runs", "AsyncRuns", "poll", TraceType.FUNCTION, "openai_run_poll_async"),
        (
            "openai.resources.beta.threads.runs",
            "AsyncRuns",
            "submit_tool_outputs",
        ...
        ("openai.resources.beta.vector_stores", "AsyncFiles", "create", TraceType.FUNCTION, "openai_file_create_async"),
        (
            "openai.resources.beta.vector_stores",
            "AsyncFiles",
            "retrieve",
        ...
        ("openai.resources.beta.vector_stores", "AsyncFiles", "delete", TraceType.FUNCTION, "openai_file_delete_async"),
        (
            "openai.resources.beta.vector_stores",
            "AsyncFiles",
            "create_and_poll",
        ...
        ("openai.resources.beta.vector_stores", "AsyncFiles", "poll", TraceType.FUNCTION, "openai_file_poll_async"),
        ("openai.resources.beta.vector_stores", "AsyncFiles", "upload", TraceType.FUNCTION, "openai_file_upload_async"),
        (
            "openai.resources.beta.vector_stores",
            "AsyncFiles",
            "upload_and_poll",
